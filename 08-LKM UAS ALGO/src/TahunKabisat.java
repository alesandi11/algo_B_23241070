...
class TahunKabisat {
  public static void main(String[] args) {
    ...
    if (year % 400 == 0) {
      ...
      double Tahun = scan.nextDouble();
      if (Tahun > 2004 ) {
              System.out.println("Tahun Kabisat");
      } else {
              System.out.println("Bukan Tahun Kabisat");
      }
      System.out.print("Masukan tahun jumlah tahun ke - 3: ");
      double tahun = scan.nextDouble();
      if (Tahun > 2004 ) {
              System.out.println("Bukan Tahun Kabisat");
      } else {
       ...
       System.out.print("Masukan tahun jumlah tahun ke - 4: ");
      double TahunKabisa = scan.nextDouble();
      if (Tahun > 2004 ) {
              System.out.println("Bukan Tahun Kabisat");
      } else {
              System.out.println("Bukan Tahun Kabisat");
